...
def rootGoal():
    ...
    rootGoal.append(emergencyIsDetectedGoal)
    rootGoal.append(isNotifiedAboutEmergencyGoal)
    rootGoal.append(centralReceivesInfoGoal)
    rootGoal.append(medicalCareReachesGoal)
...
def test_ContextSet1_centralReceivesInfoGoal(rootGoal):
    fullContext = [c1, c2, c3, c4, c5, c6, c7, c8, c9, c10]
...
def test_ContextSet1_medicalCareReachesGoal(rootGoal):
    ...
    plan = rootGoal[3].isAchievable(fullContext, None)
...
def test_ContextSet4_centralReceivesInfoGoal(rootGoal):
    fullContext = [c1, c2, c3, c6, c7]
